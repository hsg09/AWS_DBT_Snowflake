...
create or replace transient table ANALYTICS.DEV_HARNEKSINGH_marts.dim_customers
...
alter table ANALYTICS.DEV_HARNEKSINGH_marts.dim_customers cluster by (customer_id, country_code);
