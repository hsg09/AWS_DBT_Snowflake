...
create or replace transient table ANALYTICS.DEV_LOCAL_marts.dim_products
...
alter table ANALYTICS.DEV_LOCAL_marts.dim_products cluster by (category, is_active);
